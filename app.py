...
.partner-title { font-size: 22px; font-weight: 700; text-align: center; margin-bottom: 10px; }
.stat-card {
...
if os.path.exists("partners.png"):
    ...
    st.warning("partners.png not found — upload it in repo root")
